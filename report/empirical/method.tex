...
The work here will serve as the first two steps in the action research process.
\section{Action Research}
Action research is based on an iterative process.
\begin {enumerate}
\item Plan
\item Act
\item Reflect
\end{enumerate}
This report will focus on the planning part. 
